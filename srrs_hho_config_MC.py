...
def main():
                ...
                if (robotlist[i].current_task == "idle"):
                    ...
                    if (robotlist[i].type == "Replicator"):
                        ...
                        if (robotlist[i].get_previously_built() == ""):
                            ...
                            if (assembleCheck("Normal") and robotlist[i].get_previously_built() == "Replicator"):
                                assembling(robotlist[i], "Normal")
                            elif (assembleCheck("Replicator") and robotlist[i].get_previously_built() == "Normal"):
                            ...
                            if newbot and newbot.build_qual >= 0.5:
                                ...
                                if (newbot.type == "Replicator"):
                                    ...
                                    if (newbot.get_previously_built() == ""):
                                        ...
                                        if (assembleCheck("Normal") and newbot.get_previously_built() == "Replicator"):
                                            assembling(newbot, "Normal")
                                        elif (assembleCheck("Replicator") and newbot.get_previously_built() == "Normal"):
    ...
    mcdf.to_csv("./Output/HHO/srrs_hho_mc2.csv")
